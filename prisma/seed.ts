...
const userDataArr: Array<Pick<User, "name" | "imageUrl">> = [
  {
    name: "Emma Martinez",
...
async function insertFakeUsers2() {
  console.log(typeof userDataArr);
  userDataArr.forEach(async (userData) => {
